...
public enum ModArmorMaterials implements ArmorMaterial {
    STEEL("steel", 24, new int[]{ 3, 7, 5, 2 }, 9,
            SoundEvents.ARMOR_EQUIP_IRON, 1f, 0f, () -> Ingredient.of(ModItems.STEEL_INGOT.get())),
    ENDERSTEEL("endersteel", 41, new int[]{ 6, 12, 8, 4 }, 20,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 4f, 0.2f, () -> Ingredient.of(ModItems.ENDERSTEEL_INGOT.get()));
