...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> ENDERSCRAP_ORE_PLACED_KEY = registerKey("enderscrap_ore_placed");
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(Endersteel.MOD_ID, name));
    }
